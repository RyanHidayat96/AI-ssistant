...
final class AgentPrompt {
    ...
    static String build(String workDir, String toolProbe, String deviceFacts) {
        ...
        sb.append("IDENTITY AND MISSION\n")
          ...
          .append("If the current session has no decoded source yet, run one direct decode/decompile from the known artifact into $WD, then immediately query the visible UI id. Do not separately copy, list, or inventory the archive first.\n")
