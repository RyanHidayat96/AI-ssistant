...
final class AgentPrompt {
    ...
    static String build(String workDir, String toolProbe, String deviceFacts) {
        ...
        sb.append("IDENTITY AND MISSION\n")
          ...
          .append("When a target UI observation provides a resource id, source investigation starts with that exact id or its event route. Use one bounded structural query to locate its listener, state predicate, or navigation route; then inspect only the coherent region needed for the next action. Do not dump an entire decompiled file, decode a complete string table, or explore tool runtimes before this direct anchor fails twice.\n")
